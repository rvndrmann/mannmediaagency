...
export const Sidebar = () => {
  return (
    <div className="w-64 min-h-screen bg-[#1a1d24] text-white p-4 flex flex-col">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-xl font-semibold">Studio Labs AI</h1>
      </div>

      <Button
        className="bg-blue-600 hover:bg-blue-700 mb-6 w-full"
        size="lg"
      >
