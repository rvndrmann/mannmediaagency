  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      <div className="flex-1 overflow-hidden">
        <ScrollArea 
          ref={scrollAreaRef} 
          className="h-[calc(100vh-16rem)] md:h-[calc(100vh-8rem)]"
        >
      ...
      <div className="fixed bottom-[5.5rem] md:sticky md:bottom-0 left-0 right-0 w-full bg-[#1A1F2C]/95 backdrop-blur-xl pt-2 border-t border-white/10 space-y-2 p-4 z-30">
