        ...
        return new Promise((resolve, reject) => {
          try {
            ...
            getAuthToken().then(authToken => {
              console.log("[ScriptWriterAgent] Streaming request to:", funcUrl);
              ...
              fetch(funcUrl, {
                ...
                const processStream = ({ done, value }: ReadableStreamReadResult<Uint8Array>) => {
                  ...
                  console.log("[ScriptWriterAgent] Received stream chunk:", chunk);
                  ...
                  try {
                    ...
                    chunk.split('\n\n').forEach(line => {
                      ...
                      if (line.startsWith('data: ')) {
                        try {
                          ...
                          console.log("[ScriptWriterAgent] Processed stream data:", data);
                          ...
                          if (data.type === 'chunk') {
                            ...
                            console.error("[ScriptWriterAgent] Streaming error:", data.content);
                          ...
                          console.error("[ScriptWriterAgent] Error parsing SSE line:", err, line);
                        }
                      } else {
                    ...
                    console.error("[ScriptWriterAgent] Error processing stream chunk:", err);
                  }
                ...
                console.error("[ScriptWriterAgent] Fetch error for streaming:", err);
            ...
            console.error("[ScriptWriterAgent] Error setting up streaming:", err);
            reject(err);
          }
        });
      }
