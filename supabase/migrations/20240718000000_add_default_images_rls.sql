...
DROP POLICY IF EXISTS "Users can view their own default images" ON default_product_images;
...
DROP POLICY IF EXISTS "Users can create their own default images" ON default_product_images;
...
DROP POLICY IF EXISTS "Users can update their own default images" ON default_product_images;
...
DROP POLICY IF EXISTS "Users can delete their own default images" ON default_product_images;
